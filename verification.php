...
<html lang="en">
  ...
  <body>
   ...
   <div class="col-12 col-lg-8 mx-auto my-auto text-center img-responsive p-5">
    ...
    <input type="text" class="form-control py-2 px-2 my-3" placeholder=" Enter your Mobile Number">
    <button type="submit" class="form-control col-lg-6 col-8 py-2 px-2 mx-auto my-3"> <b> Continue </b></button>
    </div>
    </form>
    </div>
    </div>
