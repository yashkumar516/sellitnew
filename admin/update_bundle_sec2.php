...
<!-- header and slider end  -->
          ...
          $bid = $_REQUEST['id'];
				if(isset($_POST['product']))
				{
				    ...
				    $query = mysqli_query($con,"UPDATE `bundle_sec2` SET `product_name`='$product',`bdesc`='$description',`image`='$image' WHERE `id` = '$bid' ");
		  ...
		  ?>
				<section role="main" class="content-body content-body-modern mt-0">
                    ...
                    <!-- start: page -->
                    <?php 
                      $fetchbd = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `bundle_sec2` WHERE `id` = '$bid'"));
                    ?>
											...
											<div class="col-lg-3-5 col-xl-4-5">
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<select name="productname" class="form-control form-control-modern"  required>
															<option value="<?php echo $fetchbd['product_name'] ?>"><?php echo $fetchbd['product_name'] ?></option>
															<?php
															   $product = mysqli_query($con,"SELECT * FROM `bundle_product` WHERE `status` = 'active' ");
															   while($arp = mysqli_fetch_assoc($product))
															   {
															  ?>
                                                               <option value="<?php echo $arp['pname']  ?>"><?php echo $arp['pname']  ?></option>
															  <?php 
															   }
															   ?>
												...
												<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Product Details Image</label>
													<div class="col-lg-7 col-xl-6">
                                                        <img src="../assets/images/bundle/<?php echo $fetchbd['image'] ?>" width="100px" alt="">
														<input type="file" class="form-control form-control-modern" name="productImage" value="<?php echo $fetchbd['image'] ?>" required />
													</div>
												</div>
										...
										<div class="row">
											...
											<div class="col-lg-3-5 col-xl-4-5">
												...
												<div class="form-group row">
													...
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="Description" rows="6"> <?php echo $fetchbd['bdesc'] ?> </textarea>
													</div>
												</div>
											</div>
										</div>
