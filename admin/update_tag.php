  ...
  <!-- header and slider end  -->
		  <?php
                $id = $_REQUEST['id'];
                $seltag = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `tags` WHERE `id` = '$id'"));
                $catid = $seltag['categoryid'];
                $subcatid = $seltag['subcategoryid'];
                $childcatid = $seltag['childcatid'];
                $prodid = $seltag['product_id'];

                $selcatname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `category` WHERE `id` = '$catid'"));
                $selsubcatname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `subcategory` WHERE `id` = '$subcatid'"));
                $selchildcatname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `childcategory` WHERE `id` = '$childcatid'"));
                $selproductname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product` WHERE `id` = '$prodid'"));
                // update start here
				if(isset($_POST['tags']))
				{
					...
					$name = $_POST['Name'];
				    $query = mysqli_query($con,"UPDATE `tags` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcatid`='$childcategory',`product_id`='$productid',`tagname`='$name' WHERE `id` = '$id' ");
					if($query)
					{
											...
											<div class="col-lg-3-5 col-xl-4-5">
                                              ...
                                              <div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<select name="category" id="category" class="form-control form-control-modern" onchange="callsubcat()"  required>
															<option value="<?php echo $selcatname['category_name'] ?>" selected><?php echo $selcatname['category_name'] ?></option>
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<select name="subcategory" id="subcategory" class="form-control form-control-modern"  onchange="callchildcat()" >
															<option value="<?php echo $selsubcatname['id'] ?>" selected><?php echo $selsubcatname['subcategory_name'] ?></option>
															<?php
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
                                                        ...
                                                        <option value="<?php echo $selchildcatname['id'] ?>" selected><?php echo $selchildcatname['childcategory'] ?></option>
															<?php
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
                                                        ...
                                                        <option value="<?php echo $selproductname['id'] ?>" selected><?php echo $selproductname['product_name'] ?></option>
															<?php
                                              ...
                                              <!-- common end -->
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="Name" value="<?php echo $seltag['tagname'] ?>" placeholder="Enter Your Question" required />
													</div>
												</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="tags" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 mr-2"></i> Update Tags
								</button>
							</div>
