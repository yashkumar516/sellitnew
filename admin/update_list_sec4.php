...
<!-- header and slider end  -->
		  ...
		  <?php
			$iid = $_REQUEST['id'];
			$ingredetail = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product_detail4` WHERE `id` = '$iid' "));
			...
			// update start
				if(isset($_POST['product']))
				{
				   ...
				   if($image == null)
				   {
				    ...
				    $query = mysqli_query($con,"UPDATE `product_detail4` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcatid`='$childcategory',`product_id`='$product',`title`='$title',`desc`='$description' WHERE `id` = '$iid' ");
					...
					move_uploaded_file($_FILES['productImage']['tmp_name'], "img/".str_replace(" ","_",$_FILES['productImage']['name']));
				    $query = mysqli_query($con,"UPDATE `product_detail4` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcatid`='$childcategory',`product_id`='$product',`title`='$title',`desc`='$description',`image`='$image' WHERE `id` = '$iid' ");
