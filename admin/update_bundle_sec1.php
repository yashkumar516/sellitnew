...
<!-- header and slider end  -->
          ...
          $bid = $_REQUEST['id'];
				if(isset($_POST['product']))
				{
				    ...
				    $query = mysqli_query($con,"UPDATE `bundle_sec1` SET `product_name`='$product',`bdesc`='$description',`image`='$image' WHERE `id` = '$bid' ");
		  ...
		  ?>
				<section role="main" class="content-body content-body-modern mt-0">
                    ...
                    <!-- start: page -->
                    <?php 
                      $fetchbd = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `bundle_sec1` WHERE `id` = '$bid'"));
                    ?>
