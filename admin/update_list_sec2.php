...
<!-- header and slider end  -->
		  ...
		  <?php
			$iid = $_REQUEST['id'];
			$ingredetail = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product_detail2` WHERE `id` = '$iid' "));
			$cid = $ingredetail['categoryid'];
			$sid = $ingredetail['subcategoryid'];
			$chid = $ingredetail['childcatid'];
			$pid = $ingredetail['product_id'];
			// update start
				if(isset($_POST['product']))
				{
				   ...
				   if($image == null)
				   {
				    ...
				    $query = mysqli_query($con,"UPDATE `product_detail2` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcatid`='$childcategory',`product_id`='$product',`title`='$title',`desc`='$description' WHERE `id` = '$iid' ");
                                                                
					if($query)
					{
						echo "<script> alert('insert successfully');
						window.location.href  = 'list_sec2.php';
					...
					move_uploaded_file($_FILES['productImage']['tmp_name'], "img/".str_replace(" ","_",$_FILES['productImage']['name']));
				    $query = mysqli_query($con,"UPDATE `product_detail2` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcatid`='$childcategory',`product_id`='$product',`title`='$title',`desc`='$description',`image`='$image' WHERE `id` = '$iid' ");
		  ...
		  ?>
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<?php
						   ...
						   $subname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `subcategory` WHERE `id` = '$sid' "));
						   $childname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `childcategory` WHERE `id` = '$chid' "));
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<select name="category" id="category" class="form-control form-control-modern" onchange="callsubcat()"  required>
															<option value="<?php echo $catname['id'] ?>" selected><?php echo $catname['category_name'] ?></option>
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<option value="<?php echo $subname['id'] ?>" selected><?php echo $subname['subcategory_name'] ?></option>
															<?php
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<option value="<?php echo $childname['id'] ?>" selected><?php echo $childname['childcategory'] ?></option>
															<?php
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<option value="<?php echo $pname['id'] ?>" selected><?php echo $pname['product_name'] ?></option>
															<?php
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
													<img src="img/<?php echo $ingredetail['image'] ?>" alt="" width="100px">
														<input type="file" class="form-control form-control-modern" name="productImage" value=""/>
													</div>
												</div>
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="form-group row">
													...
													<div class="col-lg-7 col-xl-6">
														<input class="form-control form-control-modern" name="title" placeholder="Enter title"  value="<?php echo $ingredetail['title'] ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="Description" rows="6"><?php echo $ingredetail['desc'] ?></textarea>
													</div>
												</div>
											</div>
										</div>
