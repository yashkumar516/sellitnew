    ...
    if(isset($pimg)){	
	 ...
	 imagewebp($pimg,"img/".$out_img,100);
	  ...
	  if($query)
			...
			echo "<script> alert('image should be in png format1');
...
// new end
			...
			echo "<script> alert('image should be in png format2');
			
			</script>";  
		}
	}else{
			echo "<script> alert('image should be in png format3');
									...
									<section class="card card-modern card-big-info">
										<div class="card-body">
											<div class="row">
												...
												<!--		</div>-->
												<!--	<php-->
												<!--	 $fetchvar = mysqli_query($con,"SELECT * FROM `varient` WHERE `product_name` = '$pid' ");-->
												<!--	 while($arvar = mysqli_fetch_assoc( $fetchvar)){-->
	
												<!--	?>-->
            <!--                                        <div class="row my-2" id="rmtag">-->
												<!--     <div class="col-1">-->
												<!--		<label class=" control-label text-lg-right mb-0">varient</label>-->
												<!--	 </div>-->
												<!--		<div class="col-3">-->
												<!--			<input type="text" class="form-control form-control-modern" name="varient[]" value="<?php echo $arvar['varient'] ?>" required />-->
												<!--		</div>-->
												...
												<!--	  </div>-->
												<!--		<div class="col-4">-->
												<!--			<input type="text" class="form-control form-control-modern" name="upto[]"  value="<?php echo $arvar['uptovalue'] ?>" required />-->
												<!--		</div>-->

												<!--		<div class="col-2">-->
												<!--			<button class="btn btn-primary" width="100%" id="removed">remove</button>-->
												<!--		</div>   -->
												<!--	</div>-->
												<!--	<php-->
