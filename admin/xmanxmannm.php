...
$cpassword= mysqli_real_escape_string($con,$_POST['pwd_confirm']);
...
if($password === $cpassword)
    {
		$insertquery = mysqli_query($con,"insert into `users`(`username`,`user_email`,`password`) 
				...
				<div class="panel card-sign">
					...
					<div class="card-body">
						<form action="#" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group mb-3">
								<label>Phone</label>
								<input  type="text" name="phone" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control form-control-lg" />
							</div>
