  ...
  <!-- header and slider end  -->
		  <?php
				if(isset($_POST['shop']))
				{
				    ...
				    $query = mysqli_query($con,"INSERT INTO `shop_feature`(`feature_name`,`link`,`feature_desc`) values('$name','$link','$description')");
					if($query)
					{
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="featureName" value="" required />
													</div>
                                                </div>
                                                <div class="form-group row align-items-center">
												...
												<div class="form-group row">
													...
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="featureDescription" rows="6"></textarea>
													</div>
												</div>
											</div>
										</div>
