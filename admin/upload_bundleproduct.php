...
if(isset($_POST['product']))
{
	...
	$query = mysqli_query($con,"INSERT INTO `bundle_product` (`pname`,`pdesc`,`pskin`,`prprice`,`psprice`,`pimage`)
	                                VALUES('$productname','$productdesc','$skinconcern','$regularprice','$saleprice','$productimage')");
		  if($query)
		  {
											...
											<div class="row">
												...
												<div class="col-lg-3-5 col-xl-4-5">
													<div class="form-group row align-items-center">
														...
														<option value=""  class="form-control form-control-modern"> Select Skin-concern</option>
														<?php
