  ...
  <!-- header and slider end  -->
		  <?php
          $id = $_REQUEST['id'];
          $fetchhomebaanner = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `homebanner` WHERE `id` = '$id' "));
				...
				{    
                     ...
                     move_uploaded_file($_FILES['coupanImage']['tmp_name'], "img/".str_replace(" ","_",$_FILES['coupanImage']['name']));
                        ...
                        $query = mysqli_query($con,"UPDATE `homebanner` SET `image`='$thumbimage' WHERE `id` = '$id'");
                        if($query)
                        {
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
                                                        <img src="img/<?php echo $fetchhomebaanner['image'] ?>" alt="" width="100px">
