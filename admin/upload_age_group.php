	...
	<!-- header and slider end  -->
		  ...
		  <?php
				if(isset($_POST['age']))
				{
				    ...
				    $query = mysqli_query($con,"INSERT INTO `agegroup` (`age`,`age_desc`)
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="ageName" value="" required />
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="ageDescription" rows="6"></textarea>
													</div>
												</div>
											</div>
										</div>
