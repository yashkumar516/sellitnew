		  ...
		  <?php
				if(isset($_POST['category']))
				{
					...
					$image = str_replace(" ","_",$_FILES['categoryImage']['name']);
				     move_uploaded_file($_FILES['categoryImage']['tmp_name'], "../assets/images/category/".str_replace(" ","_",$_FILES['categoryImage']['name']));
					 $thumbimage = str_replace(" ","_",$_FILES['categorythumb']['name']);
					 move_uploaded_file($_FILES['categorythumb']['tmp_name'], "../assets/images/category/".str_replace(" ","_",$_FILES['categorythumb']['name']));
					 $query = mysqli_query($con,"INSERT INTO `category` (`category_name`,`category_image`,`thumbimage`,`category_desc`) values('$name','$image','$thumbimage','$description') ");
					if($query)
					{
										...
										<div class="row">
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"> Thumb Image(333*312 px)</label>
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="categorythumb" value="" required />
													</div>
												     </div>

													<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"> Banner Image(1110*500 px)</label>
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="categoryImage" value="" required />
													</div>
												</div>
