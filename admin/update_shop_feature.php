  ...
  <!-- header and slider end  -->
          <?php
             $id = $_REQUEST['id'];
				if(isset($_POST['shop']))
				{
					$name = $_POST['featureName'];
					$link = $_POST['link'];
					$description = $_POST['featureDescription'];
				    $query = mysqli_query($con,"UPDATE  `shop_feature` SET `feature_name`='$name',`link`='$link',`feature_desc`='$description' WHERE `id` = '$id' ");
					if($query)
					{
		  ...
		  ?>
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Feature Name</h2>
					...
					<form  action="#" method="post" enctype="multipart/form-data">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Feature Details</h2>
												<p class="card-big-info-desc">Add here the category description with all details and necessary information.</p>
                                            </div>
                                            <?php 
                                              $feat = mysqli_query($con,"SELECT * FROM `shop_feature` WHERE `id` = '$id' ");
                                              $arfeat = mysqli_fetch_assoc($feat);
                                            ?>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Feature Name</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="featureName" value="<?php echo $arfeat['feature_name'] ?>" required />
													</div>
                                                </div>
                                                <div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Feature Link</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="link" value="<?php echo $arfeat['link'] ?>" required />
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="featureDescription" rows="6"><?php echo $arfeat['feature_desc'] ?></textarea>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="shop" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
