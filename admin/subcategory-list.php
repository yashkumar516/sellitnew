										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="subcategory.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Brand</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details end -->
												<tr>
													...
													<td width="13%">
														<a href="delete_subcategory.php?id=<?php echo $arsub['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_subcategory.php?id=<?php echo $arsub['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
