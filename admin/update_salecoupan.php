  ...
  <!-- header and slider end  -->
		  <?php
                $copid = $_REQUEST['id'];
                 $selcoupan = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `salecoupan` WHERE `id` = '$copid'"));

				if(isset($_POST['salecoupan']))
				{
					 $thumbimage = str_replace(" ","_",$_FILES['coupanImage']['name']);
                     move_uploaded_file($_FILES['coupanImage']['tmp_name'], "img/".str_replace(" ","_",$_FILES['coupanImage']['name']));
                     $row = mysqli_num_rows(mysqli_query($con,"SELECT * FROM `salecoupan`"));
                   
                    $query = mysqli_query($con,"UPDATE `salecoupan` SET `coupanimage` ='$thumbimage' WHERE `id` = '$copid' ");
					if($query)
					{
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">coupan Image</h2>
												<p class="card-big-info-desc">Upload coupan image</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"> Sale coupan Image(1110*500 px)</label>
													<div class="col-lg-7 col-xl-6">
                                                          <img src="img/<?php echo $selcoupan['coupanimage'] ?>" alt="" width="100px">
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="salecoupan" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 mr-2"></i> Save Coupan
								</button>
							</div>
