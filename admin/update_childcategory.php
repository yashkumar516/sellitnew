 ...
 <!-- header and slider end  -->
          ...
          <?php
				...
				if(isset($_POST['submit']))
				{
					...
					$name = $_POST['Name'];
				    $query = mysqli_query($con,"UPDATE `childcategory` SET `categoryid`='$cat_id',`subcatid`='$subcat_id',`childcategory`='$name' WHERE `id` = '$id'");
					if($query)
					{
		  ...
		  ?>
				<section role="main" class="content-body content-body-modern mt-0">
                    ...
                    <?php
                       $select = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `childcategory` WHERE `id` = '$id' "));
                       $cid = $select['categoryid']; 
                       $sid = $select['subcatid']; 
                    ?>
						<div class="row">
							<div class="col">
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
                                                        ...
                                                        <?php 
                                                          $selcat = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `category` WHERE `id` = '$cid' "));
                                                        ?>
                                                        <option value="<?php echo  $selcat['id'] ?>" selected ><?php echo  $selcat['category_name'] ?></option>
														<?php
														$selectcat = mysqli_query($con,"SELECT * FROM `category` WHERE `id` != '4' And `id` != '$cid' ");
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<select name="subcategory" id="subcategory" class="form-control form-control-modern">
                                                            <?php
                                                              $selsub = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `subcategory` WHERE `id` = '$sid' "));
                                                        
                                                           ?>
                                                           <option value="<?php echo $selsub['id'] ?>"><?php echo $selsub['subcategory_name'] ?></option>
												...
												<div class="form-group align-items-center" id="tag">
                                                 <?php
                                                  $selectseries = mysqli_query($con,"SELECT * FROM `childcategory` WHERE `id` = '$id' ");
                                                  while($arseries = mysqli_fetch_assoc($selectseries)){
												 ?>
												<div class="row my-1" id="rmtag">
													<label class="col-3 control-label text-lg-right mb-0"> Series Name</label>
													<div class="col-lg-6 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="Name" value="<?php echo $arseries['childcategory'] ?>" required />
													</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="submit" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 mr-2"></i> Update Series
								</button>
							</div>
