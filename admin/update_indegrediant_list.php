...
<!-- header and slider end  -->
          ...
          $iid = $_REQUEST['id'];
				if(isset($_POST['Ingredients']))
				{
				    ...
				    $query = mysqli_query($con,"UPDATE `indegre_list` SET `category_name` = '$category',`product_id` = '$product',`title`= '$title',`content` = '$description' WHERE `id` = '$iid' ");
					...
					else
					{
                        echo "<script>
                         ...
                         window.location.href = 'update_indegrediant_list.php';
                          </script>";	
					}
				}
		  ?>
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Ingredients</h2>
                    ...
                    <?php                                   
                           $iquery = mysqli_query($con,"SELECT * FROM `indegre_list` WHERE `id` = '$iid'");
							  $iar = mysqli_fetch_assoc($iquery);   
							  $pd = $iar['product_id'];               
                          ?>
						<div class="row">
							<div class="col">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Ingredients Details</h2>
												<p class="card-big-info-desc">Add here the Ingredients description with all details and necessary information.</p>
											</div>
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<select name="category" id="categoryname" class="form-control form-control-modern"  required>
                                                    <option value="<?php echo $iar['category_name'] ?>" selected><?php echo $iar['category_name'] ?></option>
															 ...
															 <?php
                                                              $category = mysqli_query($con,"SELECT * FROM `category` WHERE `status` = 'active' ");
                                                               ...
                                                               {   
                                                                 ?>
                                                                 <option value="<?php echo $array['category_name'] ?>"><?php echo $array['category_name'] ?></option>
                                                                 <?php
                                                               }
                                                           ?>
                                                           <!-- fetch category end -->
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
													<select name="productname" id="product" class="form-control form-control-modern"  required>
													<?php 
													  $selp = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product` WHERE `id` = ' $pd' "));
													?>
                                                    <option value="<?php echo  $pd ?>" selected><?php echo $selp['product_name'] ?></option>
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="title" value="<?php echo $iar['title'] ?>" required />
													</div>
												</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="Ingredients" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 mr-2"></i> Save Ingredients
								</button>
							</div>
							...
							<!-- <div class="col-12 col-md-auto ml-md-auto mt-3 mt-md-0">
								<a href="#" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
									<i class="bx bx-trash text-4 mr-2"></i> Delete Ingredients
								</a>
							</div> -->
						</div>
					</form>
