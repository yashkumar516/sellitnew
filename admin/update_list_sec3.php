...
<!-- header and slider end  -->  
		  <?php
				...
				if(isset($_POST['product']))
				{
				    ...
				    $query = mysqli_query($con,"UPDATE `product_detail3` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcatid`='$childcategory',
		  ...
		  ?>
				<section role="main" class="content-body content-body-modern mt-0">
					...
					<?php
	                    $videodetail = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product_detail3` WHERE `id` = '$vid'"));
