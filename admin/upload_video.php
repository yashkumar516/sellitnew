...
if(isset($_POST['submit']))
{
    ...
    move_uploaded_file($_FILES['video']['tmp_name'], "video/".str_replace(" ","_",$_FILES['video']['name']));
    $count = mysqli_fetch_assoc(mysqli_query($con,"SELECT count(*) as `total` FROM `video`"));
    $entry = $count['total'];
    if($entry >= 1)
    {
        echo  '<script> alert("It is not possible");
		window.location.href = "video-list.php";
		</script>';   
    }
    else
    {	
       $insertbanner = mysqli_query($con,"INSERT INTO `video`(`name`) VALUES ('$videoname')");
       if( $insertbanner)
       {
...
?>	
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Video Name</h2>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Video</h2>
												<p class="card-big-info-desc">Upload your Video</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Video (1903*500 px)</label>
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="video" value="" required />
													</div>
												</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="submit" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 mr-2"></i> Save Video
								</button>
							</div>
