  ...
  <!-- header and slider end  -->
		  <?php
				if(isset($_POST['menu']))
				{
					...
					$query = mysqli_query($con,"INSERT INTO `menu_mgt` (`name`,`link`,`description`) values('$name','$link','$description') ");
					if($query)
					{
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="MenuName" value="" required />
													</div>
												</div>
												<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Menu Link</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="link" value="" />
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="MenuDescription" rows="6"></textarea>
													</div>
												</div>
											</div>
										</div>
