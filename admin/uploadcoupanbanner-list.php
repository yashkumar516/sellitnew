									...
									<div class="datatables-header-footer-wrapper">
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="uploadcoupanbanner.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Sale Coupan</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchbanner = mysqli_query($con,"SELECT * FROM `salecoupan`");
											...
											<!-- fetch category details end -->
											    <tr>
													...
													<td width="23%">
														<a href="delete_salecoupan.php?id=<?php echo $arbanner['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_salecoupan.php?id=<?php echo $arbanner['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
                                                    <td><img src="img/<?php echo $arbanner['coupanimage'] ?>" width="100px" alt=""></td>
...
swal({ title: "warning",
 ...
 type: "success"}).then(okay => {
   if (okay) {
    window.location.href = 'change_salecoupan_status.php?id='+id;
  }
  else
  {
