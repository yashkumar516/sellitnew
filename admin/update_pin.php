  ...
  <!-- header and slider end  -->
          <?php
             $pinid = $_REQUEST['id'];
				if(isset($_POST['pin']))
				{
					$name = $_POST['pinnumber'];
					$description = $_POST['description'];
					 $query = mysqli_query($con,"UPDATE `pincode` SET `pinnumber`='$name',`description`='$description' ");
					if($query)
					{
		  ...
		  ?>
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Pincode Number</h2>
                    ...
                    <?php 
                      $selectpin = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `pincode` WHERE `id` = '$pinid' "));
                    ?>
						<div class="row">
							<div class="col">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Pincode Details</h2>
												<p class="card-big-info-desc">Add here the Pincode description with all details and necessary information.</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Pincode Number</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="pinnumber" maxlength="6" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="<?php echo $selectpin['pinnumber'] ?>" required />
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="description" rows="6"><?php echo $selectpin['description'] ?></textarea>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="row action-buttons">
							<div class="col-12 col-md-auto">
								<button type="submit" name="pin" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
									<i class="bx bx-save text-4 mr-2"></i> Update Pincode
								</button>
							</div>
