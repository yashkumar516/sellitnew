										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details end -->
												<tr>
													...
													<td >
														<a href="series-list.php?id=<?php echo $arch['id'] ?>"> <button class="btn btn-success">update series</button></a>
													</td>
												...
												<?php
												 ...
												 <tr style="display:none;">
													...
													<td><a href="#"><strong><?php echo $arch['id'] ?></strong></a></td>
													<td >
														<a href="update_childcategory.php?id=<?php echo $arch['id'] ?>"> <button class="btn btn-success">update series</button></a>
													</td>
													<td><?php echo $catname['category_name'] ?></td>
													<td><?php echo $arch['subcategory_name'] ?></td>
