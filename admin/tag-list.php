 	...
 	<!-- end sidebar -->
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Product Detail</h2>
									...
									<div class="datatables-header-footer-wrapper">
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="tag.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Tag</a>
												</div>
												...
												<div class="col-12 col-lg-auto pl-lg-1">
													<div class="search search-style-1 search-style-1-lg mx-lg-auto">
														<div class="input-group">
															<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Detail">
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchdetail = mysqli_query($con,"SELECT * FROM `tags`");
												while($ardetail = mysqli_fetch_assoc($fetchdetail))
												{
													$p = $ardetail['product_id'];
											  ?>
											<!-- fetch category details end -->
												<tr>
													<td width="30"><input type="checkbox" name="checkboxRow1" class="checkbox-style-1 p-relative top-2" value="" /></td>
													<td width="8%"><a href="#"><strong><?php echo $ardetail['id'] ?></strong></a></td>
													<td width="23%">
														<a href="delete_tag.php?id=<?php echo $ardetail['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_tag.php?id=<?php echo $ardetail['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
													<?php 
                                                       $pname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product` WHERE `id` ='$p' "));
													?>
                                                    <td width="23%"><a href="#"><strong><?php echo $pname['product_name'] ?></strong></a></td>
													<td width="23%"><?php echo $ardetail['tagname'] ?></td>
										
													<td>
													<?php
													$did = $ardetail['id'];
													$checkstatus = $ardetail['status'];
													if($checkstatus == 'active')
													{
													   echo	'<button class="btn btn-success" onclick="return changestatus('.$did.')">'.$checkstatus.'</button>';
													}
													else
													{
														echo'<button class="btn btn-danger" onclick="return changestatus('.$did.')">'.$checkstatus.'</button>';	
													}
													?>
													</td>
												</tr>
...
<!-- status script start here -->
   ...
   {
        var id = gid;
		var url = 'change_tag_status.php?id='+id;
