										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="upload_menu.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Menu</a>
												</div>
												<div class="col-8 col-lg-auto ml-auto mb-3 mb-lg-0">
													<div class="d-flex align-items-lg-center flex-column flex-lg-row">
														...
														<select class="form-control select-style-1 filter-by" name="filter-by">
															...
															<option value="3">menu Name</option>
												...
												<div class="col-12 col-lg-auto pl-lg-1">
													<div class="search search-style-1 search-style-1-lg mx-lg-auto">
														<div class="input-group">
															<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Menu">
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											<thead>
												<tr>
													...
													<th width="23%">Menu Name</th>
													<th width="23%">Menu Link</th>
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchmenu = mysqli_query($con,"SELECT * FROM `menu_mgt`");
												while($armenu= mysqli_fetch_assoc($fetchmenu))
												{
											  ?>
											<!-- fetch category details end -->
												<tr>
													<td width="30"><input type="checkbox" name="checkboxRow1" class="checkbox-style-1 p-relative top-2" value="" /></td>
													<td><a href="#"><strong><?php echo $armenu['id'] ?></strong></a></td>
													<td>
														<a href="delete_menu.php?id=<?php echo $armenu['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_menu.php?id=<?php echo $armenu['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
													<td><?php echo $armenu['name'] ?></td>
													<td><?php echo $armenu['link'] ?></td>
													<td><?php echo date('d/m/y',strtotime($armenu['date']))  ?></td>
													<td>
													<?php
													$mid = $armenu['id'];
													$checkstatus = $armenu['status'];
...
<!-- status script start here -->
   ...
   {
        var id = gid;
		var url = 'change_menu_status.php?id='+id;
