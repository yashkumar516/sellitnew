...
<!-- end sidebar  header -->
 <?php
  $vid = $_REQUEST['id'];
  $selectvarient = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `varient` WHERE `id` = '$vid' "));
  ...
  $varient = $selectvarient['varient'];
  $upto = $selectvarient['uptovalue'];
  ...
  if(isset($_POST['product']))
  {
	...
	$upto = $_POST['upto'];
	$query = mysqli_query($con,"UPDATE `varient` SET `categoryid`='$category',`subcategoryid`='$subcategory',`childcategoryid`='$childcategory',`product_name`='$model',`varient`='$varient',`uptovalue`='$upto' WHERE `id` = '$vid'");
		if($query)
		{
											...
											<div class="row">
												...
												<div class="form-group row align-items-center">
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-7 col-xl-6">
															<input type="text" class="form-control form-control-modern" name="varient" value="<?php echo $varient ?>" required />
														</div>
                                                    </div>
                                                    <div class="form-group row align-items-center">
														<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Upto Price</label>
														<div class="col-lg-7 col-xl-6">
															<input type="text" class="form-control form-control-modern" name="upto" value="<?php echo $upto ?>" required />
														</div>
													</div>
