...
if(isset($_POST['coupan']))
{
	...
	$insertquery = mysqli_query($con,"INSERT INTO `coupan`(`coupan_name`,`coupan_value`,`coupan_type`,`cart_min_value`,`coupandesc`)
													VALUES('$coupanname','$coupanvalue','$coupantype','$cartmin','$coupandsec')");
										      		...
										      		<div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
														<div class="form-group row align-items-center">
															...
															<div class="col-lg-7 col-xl-6">
																<input type="text" class="form-control form-control-modern" name="couponName" value="" required />
															</div>
														</div>
														<div class="form-group row align-items-center">
															...
															<div class="col-lg-7 col-xl-6">
																<select class="form-control form-control-modern" name="stockStatus">
																	<option value="percentage" selected>Select Type</option>
														...
														<div class="form-group row align-items-center">
															...
															<div class="col-lg-7 col-xl-6">
																<input type="text" class="form-control form-control-modern" name="couponAmount" value="" required />
															</div>
														</div>
														<div class="form-group row align-items-center">
															<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Cart Minimum value</label>
															<div class="col-lg-7 col-xl-6">
																<input type="text" class="form-control form-control-modern" name="minvalue" value="" required />
															</div>
														</div>
														<div class="form-group row">
															<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
															<div class="col-lg-7 col-xl-6">
																<textarea class="form-control form-control-modern" name="couponDescription" rows="6"></textarea>
															</div>
														</div>
										      		</div>
