...
if(isset($_POST['banner']))
{
	...
	$row = mysqli_num_rows(mysqli_query($con,"SELECT * FROM `banner` WHERE `category` = '$page' "));

	if($row>=1)
	{
        echo  "<script> alert('banner of this page is already exist ');
    ...
    $insertbanner = mysqli_query($con,"INSERT INTO `banner`(`banner_image`,`category`,`title`)
                                                     VALUES ('$bannerimage','$page','$title')");
       if( $insertbanner)
       {
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														...
														<option value="" class="form-control form-control-modern">choose your page</option>
														...
														<option value="Ear Buds" class="form-control form-control-modern">Ear Buds</option>
														</select>
													</div>		 
													</div>
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="bannertitle" value="" required />
													</div>
												</div>		 
													</div>
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="bannerImage" value="" required />
													</div>
												</div>		 
													</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-2-5 col-xl-1-5">
												...
												<h2 class="card-big-info-title">Banner Details</h2>
												<p class="card-big-info-desc">Add here the Banner description with all details and necessary information.</p>
											</div>
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Banner Name</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="bannerName" value="" required />
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="bannerDescription" rows="6"></textarea>
													</div>
												</div>
											</div>
										</div>
