  ...
  <!-- header and slider end  -->
		  <?php
				...
				{
					$name = $_POST['Name'];
					$image = str_replace(" ","_",$_FILES['bnnImage']['name']);
					$row = mysqli_num_rows(mysqli_query($con,"SELECT * FROM `category`"));
				
					move_uploaded_file($_FILES['bnnImage']['tmp_name'], "img/".str_replace(" ","_",$_FILES['bnnImage']['name']));
				    $query = mysqli_query($con,"INSERT INTO `category` (`category_name`,`category_image`) values('$name','$image')");
					if($query)
					{
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="bnnImage" value="" required />
													</div>
												  </div>
												  <div class="form-group row align-items-center">
