		  ...
		  <?php
				if(isset($_POST['subcategory']))
				{
					...
					$image = str_replace(" ","_",$_FILES['subcategoryImage']['name']);
					move_uploaded_file($_FILES['subcategoryImage']['tmp_name'], "../assets/images/subcategory/".str_replace(" ","_",$_FILES['subcategoryImage']['name']));
				    $query = mysqli_query($con,"INSERT INTO `subcategory` (`category_id`,`subcategory_name`,`subcategory_image`,`subcategory_desc`)
                     values('$categoryid','$name','$image','$description') ");

                     if($query)
                     {
                        echo "<script>
                        alert(' subcategory insert succesfully')
                        </script>";
                     }
											...
											<div class="col-lg-3-5 col-xl-4-5">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="file" class="form-control form-control-modern" name="subcategoryImage" value="" required />
													</div>
												</div>
								...
								<section class="card card-modern card-big-info">
									<div class="card-body">
										<div class="row">
											...
											<div class="col-lg-3-5 col-xl-4-5">
                                            <div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"> Category </label>
													<div class="col-lg-7 col-xl-6">
														<select name="category_id" id="category_name" class="form-control form-control-modern">
												...
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="SubcategoryName" value="" required />
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
													<div class="col-lg-7 col-xl-6">
														<textarea class="form-control form-control-modern" name="subcategoryDescription" rows="6"></textarea>
													</div>
												</div>
											</div>
										</div>
