...
`bluetooth`,`finger_touch`,`gps`,`warenty`,`age`,`conditions`,`pcondition`,`charger`,`pencil`,`boximei`,`billimei`) VALUES('$user','$catid','$mid','$mobilename','$modelimg','$offerprice',
...
'$sconditionwat[1]','$pconditionwat[1]','$chargerwat[1]','$pencilwat[1]','$boximeiwat[1]','$billimeiwat[1]') ");
if($insertenquiry)
{ 
