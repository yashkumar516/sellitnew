    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mx-auto">
                <h1 class="sell-header text-center">Sell Your Mobile</h1>  
                </div>
        </div>
    </div>
</section>
    ...
    <h1 class="select-brand-heading pb-3">Select Brand</h1>
        ...
        <?php
          ...
          <div class="col-lg-2 col-3 mt-4">
           <a href="oldmobile.php?id=<?php echo $artop['id'] ?>"> <img src="../admin/img/<?php echo $artop['subcategory_image'] ?>" class="img-fluid box1" alt=""></a> 
          </div>
          <?php
           }
           ?>
