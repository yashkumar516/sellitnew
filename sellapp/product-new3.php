    ...
    <div class="container">
        ...
        <div class="col-lg-6 px-0" id="selllimg">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-new">
                <div class="modscren">
                    <form action="defect1.php?vid=<?php echo $vid ?>&&bid=<?php echo $bid ?>&&mid=<?php echo $mid ?>" method="post" >
                ...
                <div class="text-center mt-4">
                   ...
                   <button class="btn contin-btn" name="screen">Continue  <i class="fas fa-arrow-right"></i></button>
                </div>
                </form>
            </div>
            </div>
