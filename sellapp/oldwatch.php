...
<section class="sell-section">
    <h1 class="sell-header text-center">Sell Old <span class="sell-title-head"> <?php echo $selectquery['subcategory_name'] ?> </span>Watch </h1>
</section>
            ...
            <div class="row" id="ajaxrespon">
                ...
                ?>
                    <div class="col-lg-2 col-4 mt-2 px-1">
                        <a href="watchsold.php?id=<?php echo $armodel['id'] ?>&&bid=<?php echo $id ?>">
