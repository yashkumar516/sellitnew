        ...
        <div class="col-lg-12 col-12  mx-auto card">
            <div class="row" id="sell">
                <div class="col-lg-12 col-12">
                    <div>
                        <p class="">SellIt Repair offers you a 6 month + 1 month breakage warranty on every mobile screen repaired/replaced by us from the date of invoice. We also provide 3 months warranty on all the other spare parts that we replace.</p><br>
                    </div>
                    ...
                    <ul class="list-unstyled">
                        <ul class=w-text>
                            ...
                            <li>In case the old screen of your device is not handed over to the technician, the warranty is applicable only for 3 months.
                                .</li>
                        </ul>
                    </ul>
                    ...
                    <ul class="list-unstyled">
                        <ul class=w-text>
                            ...
                            <li>Send us your phone number/order number/IMEI Number. Just about any of it at support@sellit.in</li>

                        </ul>
                    </ul>
                    <h4>How can I claim my warranty?</h4>
                    <p>You can claim the warranty by writing to us at support@sellit.in with the service details and the invoice delivered to you at the time of repair. If you need any further assistance, please connect via Chat or write to us at support@Sellit.in</p>
                    ...
                    <h4>Our warranty also does not cover the outcome of a repair if certain pre-repair conditions exist, including:</h4>
                    <ul class="list-unstyled">
                        <ul class=w-text>
                    ...
                    <p>Note: Refund is not applicable to the spare part as on screen. Please refer to your order email for more information.</p>
                </div>
            </div>
        </div>
    </div>
